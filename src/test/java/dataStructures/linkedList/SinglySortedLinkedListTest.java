...
public class SinglySortedLinkedListTest {

	private SinglySortedLinkedList<Integer, String> list1;
	private SinglySortedLinkedList<Integer, String> list2;
	
	@Before
	public void setUp() {
		this.list1 = new SinglySortedLinkedList<Integer, String>();
		this.list2 = new SinglySortedLinkedList<Integer, String>();
	}
	...
	public void linkedListShouldUnionCorrectly(){
		...
		assertEquals("SinglySortedLinkedList [1, 2, 5, 9, 18, 23, 32, 72, 85, 100]", list1.toString());
		assertEquals("SinglySortedLinkedList [10, 39, 61]", list2.toString());
		list1.union(list2);
		assertEquals("SinglySortedLinkedList [1, 2, 5, 9, 10, 18, 23, 32, 39, 61, 72, 85, 100]", list1.toString());
		
	}
	
	private void loadList1() {
		list1.insert(new SinglyNode<Integer, String>(1, "AA"));
		list1.insert(new SinglyNode<Integer, String>(9, "BA"));
		list1.insert(new SinglyNode<Integer, String>(5, "KL"));
		list1.insert(new SinglyNode<Integer, String>(2, "KH"));
		list1.insert(new SinglyNode<Integer, String>(32, "TU"));
		list1.insert(new SinglyNode<Integer, String>(100, "VW"));
		list1.insert(new SinglyNode<Integer, String>(85, "OO"));
		list1.insert(new SinglyNode<Integer, String>(72, "SH"));
		list1.insert(new SinglyNode<Integer, String>(23, "AW"));
		list1.insert(new SinglyNode<Integer, String>(18, "PP"));
	}
	
	private void loadList2() {
		list2.insert(new SinglyNode<Integer, String>(10, "BB II"));
		list2.insert(new SinglyNode<Integer, String>(61, "UH"));
		list2.insert(new SinglyNode<Integer, String>(39, "CI"));
	}
}
