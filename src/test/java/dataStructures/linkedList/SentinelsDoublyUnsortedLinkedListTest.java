...
public class SentinelsDoublyUnsortedLinkedListTest {
	
	private SentinelsDoublyUnsortedLinkedList<Integer, String> list1;
	private SentinelsDoublyUnsortedLinkedList<Integer, String> list2;
	
	@Before
	public void setUp() {
		this.list1 = new SentinelsDoublyUnsortedLinkedList<Integer, String>();
		this.list2 = new SentinelsDoublyUnsortedLinkedList<Integer, String>();
	}
	...
	public void itShouldDeleteCorrectly(){
		...
		assertEquals(null, this.list1.search(85).getKey());
	}
	...
	public void linkedListShouldUnionCorrectly(){
		...
		assertEquals("SentinelsDoublyLinkedList [18, 23, 91, 85, 100, 32, 2, 5, 9, 1]", list1.toString());
		assertEquals("SentinelsDoublyLinkedList [39, 61, 10]", list2.toString());
		list1.union(list2);
		assertEquals("SentinelsDoublyLinkedList [18, 23, 91, 85, 100, 32, 2, 5, 9, 1, 39, 61, 10]", list1.toString());
